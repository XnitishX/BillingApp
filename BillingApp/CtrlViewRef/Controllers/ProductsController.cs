...
namespace BillingApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var products = db.Products.Include(p => p.Manufacturer).Include(p => p.Type);
        ...
        {
            ViewBag.mid = new SelectList(db.Manufacturers, "mid", "name");
            ViewBag.tid = new SelectList(db.Types, "tid", "name");
            return View();
        }
